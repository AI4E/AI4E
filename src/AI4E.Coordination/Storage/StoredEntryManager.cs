...
namespace AI4E.Coordination.Storage
{
    public sealed class StoredEntryManager : IStoredEntryManager
    {
        ...
        public IStoredEntry Create(CoordinationEntryPath path, CoordinationSession session, bool isEphemeral, ReadOnlySpan<byte> value)
        {
            if (path == null)
            ...
            return new StoredEntry(path,
                                   ...
                                   version: 1,
                                   storageVersion: 1,
                                   ephemeralOwner: isEphemeral ? session : default(CoordinationSession?),
                                   currentTime,
                                   currentTime);
        }

        public IStoredEntry AcquireWriteLock(IStoredEntry storedEntry, CoordinationSession session)
        {
            if (storedEntry == null)
        ...
        public IStoredEntry ReleaseWriteLock(IStoredEntry storedEntry, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
        ...
        public IStoredEntry AcquireReadLock(IStoredEntry storedEntry, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
        ...
        public IStoredEntry ReleaseReadLock(IStoredEntry storedEntry, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
        ...
        public IStoredEntry Remove(IStoredEntry storedEntry, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
        ...
        public IStoredEntry SetValue(IStoredEntry storedEntry, ReadOnlySpan<byte> value, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
        ...
        public IStoredEntry AddChild(IStoredEntry storedEntry, CoordinationEntryPathSegment child, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
        ...
        public IStoredEntry RemoveChild(IStoredEntry storedEntry, CoordinationEntryPathSegment child, CoordinationSession session)
        {
            if (storedEntry == null)
                throw new ArgumentNullException(nameof(storedEntry));
