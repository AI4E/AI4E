...
{
    internal sealed class CoordinationCacheManager : ICoordinationCacheManager
    {
        private readonly CoordinationEntryCache _cache;
        private readonly ICoordinationLockManager _lockManager;

        public CoordinationCacheManager(CoordinationEntryCache cache, ICoordinationLockManager lockManager)
        {
            if (cache == null)
