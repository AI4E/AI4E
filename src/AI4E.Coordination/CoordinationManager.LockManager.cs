...
namespace AI4E.Coordination
{
    ...
    {
        private sealed class LockManager : ICoordinationLockManager
        {
            #region Fields

            [Obsolete]
            private readonly CoordinationManager<TAddress> _coordinationManagerXX;
            ...
            public LockManager(ICoordinationManager coordinationManager,
...
#pragma warning disable CS0612
                _coordinationManagerXX = (CoordinationManager<TAddress>)coordinationManager;
#pragma warning restore CS0612
            ...
            private async Task<IStoredEntry> ReleaseWriteLockAsync(IStoredEntry entry)
            {
                ...
                {
                    await _coordinationManager.DisposeAsync();
                    throw;
                }
            }
            ...
            {
                var cancellation = _coordinationManagerXX._disposeHelper.DisposalRequested;
