...
namespace AI4E.Storage.Projection
{
    ...
    internal sealed class ProjectionTargetMetadataEntry
    {
        ...
        {
            return new ProjectionTargetDescriptor(TypeResolver.Default.LoadType(entry.TargetType.AsSpan()), entry.StringifiedTargetId);
        }
    }
    ...
    internal sealed class ProjectionSourceEntry
    {
        ...
        {
            return new ProjectionSourceDescriptor(TypeResolver.Default.LoadType(Type.AsSpan()), Id);
        }
    }
    ...
    internal sealed class ProjectionSourceMetadataEntry
    {
        ...
        {
            return new ProjectionSourceDescriptor(TypeResolver.Default.LoadType(entry.SourceType.AsSpan()), entry.SourceId);
        }
    ...
    internal sealed class ProjectionTargetEntry
    {
        ...
        {
            return new ProjectionTargetDescriptor(TypeResolver.Default.LoadType(Type.AsSpan()), Id);
        }
    }
    ...
    internal sealed class DependencyEntry
    {
        ...
        public ProjectionSourceDependency ToDescriptor()
        {
            return new ProjectionSourceDependency(
                new ProjectionSourceDescriptor(TypeResolver.Default.LoadType(Type.AsSpan()), Id),
                ProjectionRevision);
        }
    }
