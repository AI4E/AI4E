...
{
    [TestClass]
    public class ValueTaskCompletionSourceOfTTests
    {
        [TestMethod]
        ...
        public void DefaultTrySetResultTest()
        {
            ...
            Assert.IsFalse(valueTaskCompletionSource.TrySetResult(new object()));
        }
        ...
        public void DefaultSetResultTest()
        {
            ...
            {
                valueTaskCompletionSource.SetResult(new object());
            });
        }
        ...
        private ValueTaskCompletionSource<object> GetDefault()
        {
            return default;
        }
        ...
        public void TrySetResultTest()
        {
            ...
            Assert.IsTrue(valueTaskCompletionSource.TrySetResult(new object()));
        ...
        private ValueTaskCompletionSource<object> GetCompleted()
        {
            var result = ValueTaskCompletionSource<object>.Create();
        ...
        [TestMethod]
        public void DefaultGetResultTest()
        {
            var valueTaskCompletionSource = GetDefault();
            var valueTask = valueTaskCompletionSource.Task;

            Assert.IsNull(valueTask.GetAwaiter().GetResult());
        }
