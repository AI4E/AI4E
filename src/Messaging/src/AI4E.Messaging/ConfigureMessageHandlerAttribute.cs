...
namespace AI4E.Messaging
{
    ...
    public abstract class ConfigureMessageHandlerAttribute : Attribute
    {
        ...
        protected abstract void ConfigureMessageHandler(
            MessageHandlerActionDescriptor memberDescriptor, IMessageHandlerConfigurationBuilder configurationBuilder);
