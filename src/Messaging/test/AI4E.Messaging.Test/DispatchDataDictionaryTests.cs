...
namespace AI4E.Messaging
{
    ...
    {
        private IMessageSerializer Serializer { get; } = new MessageSerializer(TypeResolver.Default);

        private IMessageSerializer BuildSerializer(ITypeResolver deserializationTypeResolver)
        {
        ...
        public void CustomTypeResolverSerializeRoundtripTest()
        {
            ...
            var deserializedData = BuildSerializer(typeResolver).Roundtrip(dispatchData);
