...
{
    [TestClass]
    public class ConcurrencyIssueDispatchResultTests : DispatchResultsTestsBase
    {
        [TestMethod]
        public void SerializeRoundtripTest()
        {
            ...
            var dispatchResult = new ConcurrencyIssueDispatchResult("DispatchResultMessage", resultData);
